 ...
 */
final class Version20250225095958 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE location (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, roadnumber VARCHAR(5) DEFAULT NULL, roadname VARCHAR(255) DEFAULT NULL, zipcode VARCHAR(5) NOT NULL, townname VARCHAR(255) NOT NULL, longitude BIGINT NOT NULL, latitude BIGINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE event ADD status_id INT NOT NULL, ADD organizer_id INT NOT NULL, ADD campus_id INT NOT NULL, ADD location_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event DROP status_id, DROP organizer_id, DROP campus_id, DROP location_id');
    }
}
